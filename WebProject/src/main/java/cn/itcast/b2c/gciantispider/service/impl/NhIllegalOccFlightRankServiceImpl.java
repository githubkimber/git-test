...
public class NhIllegalOccFlightRankServiceImpl implements
	...
	public List<NhIllegalOccFlightRank> getNhIllegalOccFlightRank(int pages,
		...
		String sql = "SELECT i.flight_code,i.depairport,i.arrairport,i.flight_start_time,i.ship_Space,i.price,i.frequency from itcast_illegal_occ_flight_rank i WHERE 1=1";
	...
	public BigInteger getAllCount(String startTime, String endTime) {
		Map<String, Object> params = new HashMap<String, Object>();
        String sql = "SELECT count(*) FROM itcast_illegal_occ_flight_rank i WHERE 1=1";
        if (!Common.isEmpty(startTime)) {
            params.put("startTime", startTime);
