...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        // 1.创建job任务对象(super.getConf()获取父类的configuration对象)
...
//        TextInputFormat.addInputPath(job, new Path("hdfs://node01:8020/input"));
        // 本地文件路径
        TextInputFormat.addInputPath(job, new Path("file:///D:\\text\\input"));
        // 第二步: 设置Mapper类和K2,V2的数据类型
...
//        TextOutputFormat.setOutputPath(job, new Path("hdfs://node01:8020/out/partition_out"));
        // 本地文件路径
        TextOutputFormat.setOutputPath(job, new Path("file:///D:\\text\\out\\partition_out"));
        // 3.等待任务结束
